...
OUTDIR=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/PGLS/Alignment_CDS/
...
cd .
gunzip -c ${INDIR}${gene_name}/${species_name}.renamed.cds.fa.gz | ${BIN}muscle3.8.31_i86linux64 -in - \
-clwstrictout ${OUTDIR}${gene_name}/${species_name}.renamed.cds.aln
rm ${INDIR}${gene_name}/${species_name}.renamed.cds.*
