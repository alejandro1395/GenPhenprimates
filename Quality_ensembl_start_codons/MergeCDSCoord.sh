...
echo $Primates | tr " " "\n" | while read primate;
do python ${SRC}MergeCDSCoord.py ${INDIR}${primate}.CDS.gff.gz \
${INDIR}Aotus_nancymaae.orthos.txt ${HUMAN_MODEL}Homo_sapiens.ref_genes.tsv ${INDIR}${primate}.cds.coord.txt;
