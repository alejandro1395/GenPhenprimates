...
OUTDIR=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/Quality_ensembl_start_codons/Genes_coord/Aotus_nancymaae/
...
python ${SRC}CreateGenesCoord.py ${INDIR}Aotus_nancymaae.cds.coord.txt \
${gene_name} \
${INDIR}Aotus_nancymaae.orthos.txt \
${HUMAN_MODEL}Homo_sapiens.ref_genes.tsv \
${OUTDIR}${gene_name}/${gene_name}.cds.coord.txt
