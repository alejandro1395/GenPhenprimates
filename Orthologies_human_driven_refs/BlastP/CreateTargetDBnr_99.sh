...
for filepath in $(ls ${INDIR}*_*/*.nr99.pep.fa.gz);
...
-o ${OUTDIR}nrDB/allspeciesDBnr_99.pep.fa \
-c 0.99 \
-n 5 \
-M 16000 \
-d 0 \
...
gzip ${OUTDIR}nrDB/allspeciesDBnr_99.pep.fa" > ${OUTDIR}nrDB/qu/allspeciesDBnr_99.pep.fa.sh
jobname=$(echo ${OUTDIR}nrDB/qu/allspeciesDBnr_99.pep.fa.sh)
chmod 755 $jobname

#SUBMISSION TO CLUSTER
/scratch/devel/avalenzu/CNAG_interface/submit.py -c ${jobname} -o ${OUTDIR}nrDB/out/allspeciesDBnr_99.pep.out \
-e ${OUTDIR}nrDB/qu/allspeciesDBnr_99.pep.err -n merging -u 1 -t 1 -w 02:O0:00
#done
