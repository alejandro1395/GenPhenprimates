...
-o ${OUTDIR}Query/${species_name}/${species_name}.nr99.pep.fa \
-c 0.99 \
-n 5 \
-M 16000 \
-d 0 \
...
gzip ${OUTDIR}Query/${species_name}/${species_name}.nr99.pep.fa" > ${OUTDIR}Query/qu/${species_name}.nr99.pep.sh
jobname=$(echo ${OUTDIR}Query/qu/${species_name}.nr99.pep.sh)
chmod 755 $jobname
