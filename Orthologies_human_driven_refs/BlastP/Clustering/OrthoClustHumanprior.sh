...
python ${SRC}OrthoClustHumanprior.py ${INDIR} \
${SPECIES_IDs}summary_species.txt \
${TRAITS} \
${OUTDIR}" > ${OUTDIR}qu/all_species.pep.OrthoClustHumanprior.sh
jobname=$(echo ${OUTDIR}qu/all_species.pep.OrthoClustHumanprior.sh)
chmod 755 $jobname

#SUBMISSION TO CLUSTER
/scratch/devel/avalenzu/CNAG_interface/submit.py -c ${jobname} -o ${OUTDIR}out/all_species.pep.OrthoClustHumanprior.out \
-e ${OUTDIR}out/all_species.pep.OrthoClustHumanprior.err -n Clustering -u 1 -t 1 -w 23:59:00
