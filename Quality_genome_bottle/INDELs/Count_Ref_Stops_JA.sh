...
OUTDIR=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/Quality_genome_bottle/INDELs/
mkdir -p ${OUTDIR}
mkdir -p ${OUTDIR}Within_stop_codons/
SRC=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/src/Quality_genome_bottle/INDELs/
...
${gene_name} \
${species_name} \
${OUTDIR}Within_stop_codons/${gene_name}/${species_name}.indels.txt
done
#tar arxives again
...
ls ${OUTDIR}Within_stop_codons/${gene_name}/*.indels.txt | while read file; do cat $file | tail -n+2 >> ${OUTDIR}Within_stop_codons/${gene_name}/All_indels.txt; done
rm ${OUTDIR}Within_stop_codons/${gene_name}/*.indels.txt
