...
POSITIONS=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/Quality_genome_bottle/SNPs/Within_stop_codons/
ALIGNMENT=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/PGLS/Alignment_CDS/
OUTDIR=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/Quality_genome_bottle/SNPs/Between_stop_codons/
mkdir -p ${OUTDIR}
...
${POSITIONS}${gene_name}/All_stop_codons.txt \
${gene_name} \
${OUTDIR}${gene_name}/${species_name}.validated.stop_codons.txt
