...
cat ${INDIR_ALIGNMENT}${gene_name}/${species_name}.renamed.cds.aln | \
seqret -sequence stdin -osformat2 fasta -outseq stdout | \
${BIN}muscle3.8.31_i86linux64 -profile -in1 - \
-in2 ${INDIR_RESEQUENCED}${gene_name}/${species_name}.afa \
-clwstrictout ${OUTDIR}${gene_name}/${species_name}.profile.cds.aln
