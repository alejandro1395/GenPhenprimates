...
OUTDIR=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/Quality_resequenced/Check_CDS_frameshift/Frameshift_counts/
INDIR=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/Quality_resequenced/Check_CDS_frameshift/Frameshift_positions/
ALIGNMENT=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/Quality_resequenced/Check_CDS_frameshift/Profile_CDS_alignments/
...
python ${SRC}Count_Ref_frameshift.py ${TREE_NAMES} \
${REFERENCE_NAMES} \
${ALIGNMENT}${dir_out}/${species_name}.profile.cds.aln \
${INDIR}${dir_out}/${species_name}.cds.frameshift.txt \
${dir_out} \
${OUTDIR}${dir_out}/${species_name}.cds.ref_count.txt
