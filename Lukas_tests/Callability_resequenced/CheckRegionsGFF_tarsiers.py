...
if individual in ['PD_0146', 'PD_0147', "PD_0167", "PD_0168", "PD_0169", "PD_0170", "PD_0171", "PD_0172", "PD_0251", "PD_0252",
'PD_0609', 'PD_0854']:
    adding = "Propithecus_coquereli_"
elif individual in ['PD_0404', 'PD_0405', "PD_0628", "PD_0629"]:
    adding = "Carlito_syrichta_"
...
with open(individual_overlap_gff, "r") as in_fh2:
    for line in in_fh2:
        ...
        feature = fields[5]
        if feature == "CDS":
            subpart = fields[11].split(";")[0].split("=")[1]
            ident = adding + subpart
