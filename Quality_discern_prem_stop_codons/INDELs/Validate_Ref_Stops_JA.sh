...
POSITIONS=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/Quality_discern_prem_stop_codons/INDELs/Within_stop_codons/
ALIGNMENT=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/PGLS/Alignment_CDS/
OUTDIR=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/Quality_discern_prem_stop_codons/INDELs/Between_stop_codons/
mkdir -p ${OUTDIR}
SRC=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/src/Quality_discern_prem_stop_codons/INDELs/
...
${POSITIONS}${gene_name}/All_indels.txt \
${gene_name} \
${OUTDIR}${gene_name}/${species_name}.validated.indels.txt
