...
OUTDIR=/scratch/devel/avalenzu/PhD_EvoGenom/GenomPhenom200primates/human_driven_results/Quality_discern_prem_stop_codons/INDELs/Within_stop_codons/
mkdir -p ${OUTDIR}
...
${gene_name} \
${species_name} \
${OUTDIR}${gene_name}/${species_name}.indels.txt
done
#tar arxives again
...
ls ${OUTDIR}${gene_name}/*.indels.txt | while read file; do cat $file | tail -n+2 >> ${OUTDIR}${gene_name}/All_indels.txt; done
rm ${OUTDIR}${gene_name}/*.indels.txt
