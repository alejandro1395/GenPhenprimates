...
python ${SRC}OrthoClustHumanprior_newBBHsLAX.py ${INDIR} \
${SPECIES_IDs}summary_species.txt \
${TRAITS} \
${OUTDIR}" > ${OUTDIR}qu/all_species.pep.OrthoClustHumanprior_newBBHsLAX.sh
jobname=$(echo ${OUTDIR}qu/all_species.pep.OrthoClustHumanprior_newBBHsLAX.sh)
chmod 755 $jobname

#SUBMISSION TO CLUSTER
/scratch/devel/avalenzu/CNAG_interface/submit.py -c ${jobname} -o ${OUTDIR}out/all_species.pep.OrthoClustHumanprior_newBBHsLAX.out \
-e ${OUTDIR}out/all_species.pep.OrthoClustHumanprior_newBBHsLAX.err -n Clustering -u 1 -t 1 -w 23:59:00
