...
python ${SRC}OrthoClustHumanprior_newBBHs.py ${INDIR} \
${SPECIES_IDs}summary_species.txt \
${TRAITS} \
${OUTDIR}" > ${OUTDIR}qu/all_species.pep.OrthoClustHumanprior_newBBHs.sh
jobname=$(echo ${OUTDIR}qu/all_species.pep.OrthoClustHumanprior_newBBHs.sh)
chmod 755 $jobname

#SUBMISSION TO CLUSTER
/scratch/devel/avalenzu/CNAG_interface/submit.py -c ${jobname} -o ${OUTDIR}out/all_species.pep.OrthoClustHumanprior_newBBHs.out \
-e ${OUTDIR}out/all_species.pep.OrthoClustHumanprior_newBBHs.err -n Clustering -u 1 -t 1 -w 23:59:00
