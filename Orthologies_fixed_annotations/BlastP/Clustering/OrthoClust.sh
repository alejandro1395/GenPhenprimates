...
python ${SRC}OrthoClust.py ${INDIR} \
${SPECIES_IDs}summary_species.txt \
${OUTDIR}" > ${OUTDIR}qu/all_species.pep.OrthoClust.sh
jobname=$(echo ${OUTDIR}qu/all_species.pep.OrthoClust.sh)
chmod 755 $jobname

#SUBMISSION TO CLUSTER
/scratch/devel/avalenzu/CNAG_interface/submit.py -c ${jobname} -o ${OUTDIR}out/all_species.pep.OrthoClust.out \
-e ${OUTDIR}out/all_species.pep.OrthoClust.err -n Clustering -u 1 -t 1 -w 23:59:00
